export default class Color {
    ...
    static darkGreen = Color.fromRGB(0,102,0)
    static darkOrange = Color.fromRGB(255,140,0)
    ...
    static fromCSSColor(color: keyof typeof Color.css_colors) {
        const hex = Color.css_colors[color]
        //return Color()
    }

    static fromHexString(hex: string): Color | undefined {
    ...
    static colorArrayToFloat32(colors: Color[]): Float32Array {
    ...
    fillF32ArrayOfSize(n: number): Float32Array {
        var colorArray: number[] = []
        for (var i=0; i<n; i++) {
